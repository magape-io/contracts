...
contract DIDFunctions {
    bytes32 private constant STO =
        0x79030946dd457157e4aa08fcb4907c422402e75f0f0ecb4f2089cb35021ff964;
    bytes32 private constant STR =
        0x99eec06400000000000000000000000000000000000000000000000000000000;
    bytes32 private constant STD =
        0xc7070b5800000000000000000000000000000000000000000000000000000000;
    bytes32 private constant DID =
        0x7148bc7200000000000000000000000000000000000000000000000000000000;
    ...
    // 更新其它资料
    function update(uint256 typ, string memory inf) public {
        assembly {
